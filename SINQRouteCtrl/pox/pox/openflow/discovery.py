...
class Discovery (EventMixin):
  ...
  _link_timeout = 1		# Modified by Heli from 10 to 0.5	<-- This will make OVS controll management plane processor busy
  _timeout_check_period = 0.5  # Modified by Heli from 5 to 0.25
