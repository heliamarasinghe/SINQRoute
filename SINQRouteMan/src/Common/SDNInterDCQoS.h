...
public:
	...
	//                             				Common Data Types                              							-                                                                                                                -
	//-------------------------------------------------------------------------------------------------------------------
	typedef IloArray<SubstrateNode> SubNodesAryType;   				// table to save a set of nodes
	...
	static void substrate_Graph_creation(SubNodesAryType&, SubLinksAryType&, IloInt&, IloInt&, IloEnv&);
	static void adjacency_list_creation(SubNodesAryType&, IloInt&, IloEnv& );
	static void substrate_graph_printing(SubNodesAryType&, IloEnv, IloInt);
	...
	static void add_meta_path(MetaSubPathAryType&, IloInt&, IloInt&, IloInt&, IloInt&, IloInt&, IloNumArray&, SubNodesAryType&, IloInt&, IloEnv&);
	...
	static IloInt check_src_dest_adjanticity(IloInt&, IloInt&, SubNodesAryType&, IloEnv&);
	static IloInt count_number_link(IloInt&, SubNodesAryType&, IloEnv&);
	static IloInt  Check_nb_hops_in_shortest_path(SubNodesAryType&, IloInt&, IloInt&, IloEnv&);
